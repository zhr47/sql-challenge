...
3. Inside your local git repository, create a directory called **EmployeeSQL**.
...
* Create a `.sql` file of your table schema.

* Create a `.sql` file of your queries.

* (Optional) Create a Jupyter Notebook of the bonus analysis.

* Push all of the above files to GitHub and post a link to your repository on BootCamp Spot.
